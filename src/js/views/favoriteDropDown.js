...
class FavoriteDropDownUI {
  ...
  renderFavoriteTickets(tickets) {
    ...
    tickets.forEach(ticket => {
      const template = FavoriteDropDownUI.favoriteTemplate(ticket, currency);
      fragment += template;
    });
  ...
  static favoriteTemplate(ticket, currencySymbol) {
    return `
...
const favoriteDropDownUI = new FavoriteDropDownUI(currencyUI);
export default favoriteDropDownUI;